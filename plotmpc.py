...
with open("mpc.log", "r") as f:
    ...
    plt.plot(C_curr, color="orange", label="Throughput Value")
    plt.plot(C_esti, color="blue", label="Throughput Estimate", linewidth='.5')
    # ax12 = plt.twinx()
    # ax12.plot(C_err, color="red")
    plt.xlabel("Chunk Value")
